        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
              ...
              {!hasSearched && (
                <div className="bg-purple-500/20 border border-purple-500/50 rounded-lg p-4">
                  <p className="text-purple-300">
                    Επιλέξτε φίλτρα και πατήστε "Αναζήτηση" για να δείτε
                    διαθέσιμους πόρους.
                  </p>
                </div>
              )}
          ...
          {currentView === "statistics" && (
            <div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 mb-8">
                ...
                <div className="space-y-4">
                  {stats.resourcesByCategory.map((item, index) => {
                    const percentage =
                      (item.count / stats.totalResources) * 100;
                    return (
                      <div key={index}>
              ...
              <div className="bg-purple-500/20 border border-purple-500/50 rounded-lg p-4">
                <p className="text-purple-300">
                  Τα στατιστικά ενημερώνονται σε πραγματικό χρόνο και παρέχουν
                  πλήρη διαφάνεια στη διαχείριση των δημοτικών πόρων.
                </p>
              </div>
            </div>
          )}
          ...
          {currentView === "transactions" && (
            <div>
              ...
              <div className="bg-purple-500/20 border border-purple-500/50 rounded-lg p-4">
                <p className="text-purple-300">
                  Ως πολίτης, έχετε πρόσβαση σε δημόσια στατιστικά και
                  πληροφορίες για τη διαχείριση των πόρων του δήμου σας. Αυτή η
                  διαφάνεια προάγει την εμπιστοσύνη και την ενημέρωση της
                  κοινότητας.
                </p>
              </div>
            </div>
